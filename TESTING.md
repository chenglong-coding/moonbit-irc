...
- Local code coverage: `moon coverage analyze -p localreview/irc -- -f summary`. No coverage upload is configured. Coverage is evidence about current code, not upstream feature coverage.
